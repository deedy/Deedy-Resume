...
1. **MacFonts** - uses fonts native to OSX - *Helvetica*, *Helvetica Neue* (and its Light and Ultralight versions) and the CJK fonts *Heiti SC*, and *Heiti TC*. The EULA of these fonts prevents distribution on Open Source.
...
## TODO
1. Merge OpenFont and MacFonts as a single style with options.
